...
class _EventEditScreenState extends State<EventEditScreen> {
  ...
  late EventTmcDetil itemEdit;

  @override
  void initState() {
    // TODO: implement initState
    itemEdit = Get.arguments['event'];
    ...
    priceController.text = CurrencyTextInputFormatter(
        ...
        .format(itemEdit.price!.toString());
    setState(() {
      is_free.value = itemEdit.isFree!;
      is_registration_close.value = itemEdit.isRegistrationClose!;
      is_list_attendees.value = itemEdit.isListAttendees!;
      mainImageMedia.value = ImageMedia(
          pk: itemEdit.mainImage!,
          display_name: "",
          image: base_url + itemEdit.mainImageUrl!);
    });
    super.initState();
  }
                            ...
                            if (!formKey.currentState!.validate()) {
                              ...
                              if (is_free.value == false &&
                                  priceController.text
                                      ...
                                      "0") {
                                GFToast.showToast(
                                    'Fees / Participant Unfilled!', context,
                                    trailing: const Icon(
                                      Icons.error_outline,
                                      color: GFColors.WARNING,
                                    ),
                              ...
                              print(eventUpload);
                              SmartDialog.showLoading(msg: "Saved Event...");
                              eventController
                                  .updateEvent(eventUpload, itemEdit.pk!)
                                  .then((value) => {
                                        SmartDialog.dismiss(),
                                        if (value == true)
                                          {
