...
class BlogCreateYoutubeScreen extends StatefulWidget {
  @override
  State<BlogCreateYoutubeScreen> createState() =>
      _BlogCreateYoutubeScreenState();
}

class _BlogCreateYoutubeScreenState extends State<BlogCreateYoutubeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("Create Embedded Youtube"),
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                //title
                const Text("Please Fill in the Youtube Video Link"),
                const Divider(
                ...
                TextFormField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        labelText: "Youtube Link (YouTube Video Link)",
                  ...
                  onPressed: () {
                    if (!formKey.currentState!.validate()) {
                      ...
                      if (validYoutubdID.value == false) {
                        GFToast.showToast('Link Youtube Invalid!', context,
                            trailing: const Icon(
                              Icons.error_outline,
                              color: GFColors.WARNING,
                            ),
                        ...
                        SmartDialog.showLoading(msg: "Send Embed Youtube...");
                        blogController
                            ...
                            .then((value) => {
                                  ...
                                  if (value == true)
                                    {
                                      GFToast.showToast(
                                          'Embed Video Youtube saved successfully',
                                          context,
                                          trailing: const Icon(
  ...
  Future<YoutubePlayerIFrame> generateYTIFrame(String youtubdID) async {
    SmartDialog.showLoading(msg: "Check Video Youtube...");
    ...
    if (value != "") {
      ...
      if (youtubeId != "") {
        ...
        if (YTF.controller != null) {
          ...
          GFToast.showToast('Invalid Youtube Link', Get.context!,
              trailing: const Icon(
                Icons.error_outline,
                color: GFColors.WARNING,
              ),
