...
class _BlogCreateScreenState extends State<BlogCreateScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("Buat Blog Baru"),
              ...
              children: [
                ...
                TextFormField(
                    ...
                    onFieldSubmitted: (String value) {
                      if (value != "") {
                        String urlYoutube = youtubeController.text;
                        String youtubeId =
                            blogController.getYoutubeVideoId(urlYoutube);
                    ...
                    decoration: const InputDecoration(
                        contentPadding:
                            EdgeInsets.symmetric(vertical: 0, horizontal: 15),
                        labelText: "Link Youtube (Optional)",
                        hintStyle: TextStyle(color: Colors.grey, fontSize: 14),
                        labelStyle: TextStyle(color: Colors.grey, fontSize: 13),
                        border: OutlineInputBorder()),
                    autocorrect: false,
                          ...
                          ? Container(
                              ...
                              child: YoutubePlayerIFrame(
                                controller: YoutubePlayerController(
                                  initialVideoId: _youtubdID.value,
                            ...
                            onPressed: () {
                              if (!formKey.currentState!.validate()) {
                                ...
                                if (mainImageMedia.value.pk == 0 &&
                                  ...
                                  SmartDialog.showLoading(msg: "Kirim Blog...");
                                  blogController
                                      ...
                                      .then((value) => {
                                            ...
                                            if (value == true)
                                              ...
                                              {
                                                Get.snackbar('Opps.',
                                                    "Terjadi Kesalahan, Blog gagal dikirim",
                                                    snackPosition:
